...
import SourceErdTableNode from "./SourceErdTableNode";
    ...
    columns: [
      {
        ...
        attributes: {
          isPrimaryKey: true,
          handleId: "pk-payment-id", // Handle ID for primary key
          isConnectable: true,
        },
      },
      {
        ...
        attributes: {
          isForeignKey: true,
          handleId: "fk-user-id-payment", // Handle ID for foreign key to users
          isConnectable: true,
        },
      },
      {
        ...
        attributes: {
          isForeignKey: true,
          handleId: "fk-order-id-payment", // Handle ID for foreign key to orders
          isConnectable: true,
        },
      },
      { name: "amount", type: "decimal", attributes: { isPrimaryKey: false } },
      {
        name: "payment_date",
        type: "timestamp",
        attributes: { isPrimaryKey: false },
...
const nodeTypes = { sourceErdTableNode: SourceErdTableNode };
...
const initialEdges = [
  ...
  },
  {
    ...
    target: "node-3",
    sourceHandle: "pk-user-id",
    targetHandle: "fk-user-id-payment",
    type: "custom-edge",
    animated: true,
  },
  {
    ...
    targetHandle: "fk-order-id-payment",
    type: "custom-edge",
    animated: true,
  },
];
...
const SourceLayoutFlow = () => {
  const initialNodes = tablesData.map((table, index) => ({
    id: `node-${index + 1}`,
    type: "sourceErdTableNode",
...
export default SourceLayoutFlow;
